...
Continuators UG iGr, Berlin

§ 1 Applicability
1.1 The following General Terms and Conditions apply to all business
relations between Continuators UG iGr („Continuators“) and the users of its online
...
and to express and pledge support financially for the respective series rgeistering their intent to purchase the next seasons of a series. 
...
b)at a later stage pay for such a a pre-order if the producers of the series and Continuators UG iGr have concluded a production agreement on the series.
